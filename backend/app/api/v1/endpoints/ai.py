...
async def analyze_crop_image(
    ...
    crop: Optional[str] = Form(default=None, description="Optional explicit Crop Name context (e.g. Tomato, Rice, Cotton, Soybean)"),
    crop_name: Optional[str] = Form(default=None, description="Alias for crop parameter"),
