      ...
      <header className="h-16 border-b border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-900/90 backdrop-blur px-4 sm:px-6 flex items-center justify-between sticky top-0 z-40 transition-colors duration-200 shadow-sm dark:shadow-none">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 hidden sm:block">
                AI Crop Health & Drone Intelligence
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden sm:flex p-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800/80 dark:hover:bg-slate-800 text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white border border-slate-200 dark:border-slate-700 transition"
