  ...
  const fieldZones: FieldZoneRecord[] = [
    {
      ...
      centerCoord: '20.2185° N, 73.8420° E (Dindori Agro Valley)',
      currentRiskTier: 'LOW',
      currentRiskScore: 24,
    ...
    },
    {
      ...
      equipmentStatus: 'Active',
      centerCoord: '20.2212° N, 73.8435° E (East Vineyard Plots)',
    ...
    },
    {
      ...
      centerCoord: '20.2168° N, 73.8448° E (South Tomato Blocks)',
      currentRiskTier: 'HIGH',
      currentRiskScore: 74,
      forecastRiskTier: 'CRITICAL',
