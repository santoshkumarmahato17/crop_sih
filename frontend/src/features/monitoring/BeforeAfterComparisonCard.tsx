...
export const BeforeAfterComparisonCard: React.FC<BeforeAfterComparisonCardProps> = ({
  ...
  return (
    <div className="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden space-y-6">
      {/* ── Top Header ── */}
      <div className="p-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-950/60 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
      ...
      <div className="px-6">
        {viewMode === 'sideBySide' ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-xs font-bold text-slate-500">
                ...
                <span className="font-mono text-emerald-600">Health: {comparison.previous_health_score}%</span>
              </div>
              <div className="relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 h-56 bg-slate-950 shadow-md">
                <img
                  src={beforeImageUrl}
                  alt="Previous State"
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-xs font-bold text-slate-500">
                ...
                <span
                  className={`font-mono ${
                    comparison.health_change < 0 ? 'text-rose-600' : 'text-emerald-600'
                  }`}
                >
              ...
              <div className="relative rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 h-56 bg-slate-950 shadow-md">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute top-2 left-2 px-2 py-1 rounded-lg bg-emerald-600/80 text-white font-mono text-[10px] font-bold">
                  Follow-up Re-scan
                </div>
              </div>
            </div>
          ...
          /* Split Slider Mode */
          <div className="relative h-64 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-md select-none">
            <img
              src={afterImageUrl}
              alt="After"
            ...
            <span className="absolute top-3 right-3 px-2 py-1 rounded-lg bg-emerald-600/80 text-white text-[10px] font-mono font-bold pointer-events-none">
              AFTER
            </span>
          </div>
        )}
      ...
      <div className="p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 space-y-3">
        {comparison.is_escalated && (
          <div className="p-4 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-xs text-slate-700 dark:text-slate-300 space-y-1.5">
